...
class EditProfileControllerImp extends GovCityControllerImp {
    ...
    if (StatusRequest.success == statusRequest) {
      if (response['status'] == "success") {
        ...
        if (usersData.isNotEmpty) {
          userModel =
              usersData.first; // Extract the first user model from the list
          // Assign values to TextEditingController instances
          username.text = userModel!.usersName.toString();
          email.text = userModel!.usersEmail.toString();
          password.text = userModel!.usersPassword.toString();
          govName.text = userModel!.usersGov.toString();
          cityName.text = userModel!.usersCity.toString();
          phone.text = userModel!.usersPhone.toString();
          image = userModel!.usersImage.toString();
      ...
      if (StatusRequest.success == statusRequest) {
        if (response['status'] == "success") {
          ...
          myServices.sharedPreferences
              .setString("userimage", userModel!.usersImage.toString());
