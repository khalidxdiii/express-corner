...
class QnACardItem extends StatefulWidget {
  final QnAPair qnaPair;

  const QnACardItem({super.key, required this.qnaPair});

  @override
  _QnACardItemState createState() => _QnACardItemState();
}

class _QnACardItemState extends State<QnACardItem> {
  bool selected = false;
