...
class EditEmailVerifyCode extends StatelessWidget {
  const EditEmailVerifyCode({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(EditEmailVerifyCodeCotrollerImp());

    return Scaffold(
        backgroundColor: AppColor.backGround,
        body: SafeArea(
          child: GetBuilder<EditEmailVerifyCodeCotrollerImp>(
