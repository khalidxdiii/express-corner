...
class CurrentCardItem extends GetView<OrdersControllerImp> {
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          if (controller
                                      .currentDataOrders[index].deliveryImage !=
                                  "empty" ||
                              controller
                                      .currentDataOrders[index].deliveryImage !=
                                  "fail") {
                        ...
                        child: ClipRRect(
                          ...
                          child: (controller.currentDataOrders[index]
                                          .deliveryImage ==
                                      "empty" ||
                                  controller.currentDataOrders[index]
                                          .deliveryImage ==
                                      "fail")
                              ? Image.asset(
                                  AppImageAsset.user,
