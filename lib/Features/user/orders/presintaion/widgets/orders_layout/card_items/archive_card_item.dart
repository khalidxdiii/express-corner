...
class ArchiveCardItem extends GetView<OrdersControllerImp> {
  const ArchiveCardItem({
    ...
    required this.delivaryImageUrl,
    required this.index,
  });
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          if (controller
                                      .archiveDataOrders[index].deliveryImage !=
                                  "empty" ||
                              controller
                                      .archiveDataOrders[index].deliveryImage !=
                                  "fail") {
                            Get.toNamed(AppRoute.openImage, arguments: {
                              "imageUrl":
                                  "${AppLink.imageUser}/$delivaryImageUrl"
                            });
                          }
                        },
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(50),
                          child: (controller.archiveDataOrders[index]
                                          .deliveryImage ==
                                      "empty" ||
                                  controller.archiveDataOrders[index]
                                          .deliveryImage ==
                                      "fail") 
                              ? Image.asset(
                                  AppImageAsset.user,
