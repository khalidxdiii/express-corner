...
class DelivaryHomePindingCardOrderItem
    extends GetView<DelivaryHomePageControllerImp> {
  const DelivaryHomePindingCardOrderItem({
    super.key,
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          if (controller.pindingDataOrders.first.userImage !=
                                  "empty" ||
                              controller.pindingDataOrders.first.userImage !=
                                  "fail") {
