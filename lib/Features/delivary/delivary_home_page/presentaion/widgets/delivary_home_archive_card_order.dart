...
class DelivaryHomePageArchiveCardOrder
    extends GetView<DelivaryHomePageControllerImp> {
  const DelivaryHomePageArchiveCardOrder({
    super.key,
              ...
              children: [
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          if (controller.archiveDataOrders.first.userImage !=
                                  "empty" ||
                              controller.archiveDataOrders.first.userImage !=
                                  "fail") {
                ...
                DefultRatingBar(
                  initialRating: double.parse(
                      controller.archiveDataOrders.first.userRating.toString()),
                  ignoreGestures: true,
