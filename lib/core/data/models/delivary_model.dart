class DelivaryModel {
  ...
  String? usersApprove;
  String? usersType;
  String? usersTypeVehicle;
  String? usersExpertise;
  String? usersImage;
  String? usersCreate;
  ...
  DelivaryModel.fromJson(Map<String, dynamic> json) {
    ...
    usersTypeVehicle = json['users_typeVehicle'];
    usersExpertise = json['users_expertise'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['users_typeVehicle'] = this.usersTypeVehicle;
    data['users_expertise'] = this.usersExpertise;
